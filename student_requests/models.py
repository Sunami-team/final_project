...
class GradeReconsiderationRequest(models.Model):
    ...
    course = models.ForeignKey(
        'courses.CourseTerm', on_delete=models.CASCADE)
...
class CourseSelectionStudentSendToAssistant(models.Model):
    student = models.ForeignKey('users.Student', on_delete=models.CASCADE)
    courses_to_drop = models.ManyToManyField('courses.CourseTerm', related_name='selection_student_send_to_assistant_drop', blank=True)
    courses_to_add = models.ManyToManyField('courses.CourseTerm', related_name='selection_student_send_to_assistant_add', blank=True)

class CourseCorrectionStudentSendToAssistant(models.Model):
    student = models.ForeignKey('users.Student', on_delete=models.CASCADE)
    courses_to_drop = models.ManyToManyField('courses.CourseTerm', related_name='correction_student_send_to_assistant_drop', blank=True)
    courses_to_add = models.ManyToManyField('courses.CourseTerm', related_name='correction_student_send_to_assistant_add', blank=True)
...
class CourseCorrectionStudentRequest(models.Model):
    student = models.ForeignKey('users.Student', on_delete=models.CASCADE)
    courses_to_drop = models.ManyToManyField('courses.CourseTerm', related_name='correction_student_requests_to_drop', blank=True)
    courses_to_add = models.ManyToManyField('courses.CourseTerm', related_name='correction_student_requests_to_add', blank=True)
    approval_status = models.BooleanField(default=False)

class CourseSelectionStudentRequest(models.Model):
    student = models.ForeignKey('users.Student', on_delete=models.CASCADE)
    courses_to_drop = models.ManyToManyField('courses.CourseTerm', related_name='selection_student_requests_to_drop', blank=True)
    courses_to_add = models.ManyToManyField('courses.CourseTerm', related_name='selection_student_requests_to_add', blank=True)
    approval_status = models.BooleanField(default=False)
