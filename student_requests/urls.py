...
urlpatterns = [
    ...
    path('professor/<int:professor_id>/courses/<int:course_id>/appeal-requests/', views.GradeReconsiderationRequestViewSet.as_view({'get':'list'}), name='grade-reconsideration-list'),
    ...
    path('professor/<int:professor_id>/courses/<int:course_id>/approve/',
         ...
         path('student/<int:student_id>/courses/<int:course_id>/appeal-request/', views.GradeReconsiderationRequestView.as_view(), name='student-reconsideration'),
    path('student/<int:pk>/course-selection/create/', views.CreateSelectionRequestByStudent.as_view(),
         name='selection-request'),
    path('student/<int:pk>/course-selection/', views.DetailSelectionRequestByStudent.as_view(),
         name='see-selection-request'),
    path('student/<int:pk>/course-selection/<int:term_id>/check/', views.SelectionShowErrors.as_view(),
         name='selection-errors-list'),
    path('student/<int:pk>/course-selection/submit/', views.SelectionSubmit.as_view(),
         name='selection-student-submit'),
    path('student/<int:pk>/course-selection/send-form/<int:term_id>/', views.SelectionSendForm.as_view(),
         name='selection-send-form'),
]